...
function AppContent() {
  ...
  // Safely check if we are on the manager side
  ...
  return (
    <>
      ...
      {isManagerRoute ? (
        ...
        ══════════════════════════════════════════ */
        <div className="min-h-screen bg-[#F9F7F3] dark:bg-[#060D0A] text-gray-900 dark:text-[#F5EDD8] font-sans transition-colors duration-300">
          <ManagerHeader />
          <div className="pt-28 px-4 md:px-10 max-w-[1920px] mx-auto pb-20">
            <Routes>
...
// Ensure the app is wrapped in the Router and ThemeProvider at the very top level
